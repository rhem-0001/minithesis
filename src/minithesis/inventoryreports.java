...
public class inventoryreports extends javax.swing.JInternalFrame {
    ...
    public void loadInventoryReport() {
        ...
        // Get current stock and calculate today's activity
        String query = "SELECT " +
                      ...
                      "pv.variant_id, " +
                      "COALESCE(SUM(CASE WHEN DATE(o.order_date) = CURDATE() THEN oi.quantity ELSE 0 END), 0) as SoldToday, " +
                      "COALESCE(SUM(CASE WHEN DATE(qr.pullout_date) = CURDATE() THEN qr.quantity_pulled ELSE 0 END), 0) as PullOutsToday " +
                      "FROM product p " +
        ...
        while(rs.next()) {
            ...
            int soldToday = rs.getInt("SoldToday");
            int pullOutsToday = rs.getInt("PullOutsToday");
            
            // Calculate start of day stock
            int startOfDayStock = currentStock + soldToday + pullOutsToday;
            ...
            coldata.add(size);
            coldata.add(startOfDayStock);
            coldata.add(soldToday);
            coldata.add(pullOutsToday);
    ...
    private void initComponents() {
        ...
        btsPOS = new javax.swing.JButton();
        ...
        datefrom.setFont(new java.awt.Font("Showcard Gothic", 1, 14)); // NOI18N
        datefrom.setForeground(new java.awt.Color(255, 255, 255));
        datefrom.setText("From : ");

        dateto.setFont(new java.awt.Font("Showcard Gothic", 1, 14)); // NOI18N
        ...
        btsPOS.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btsPOS.setText("POS");
        btsPOS.addActionListener(this::btsPOSActionPerformed);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(btsPOS, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())))
        );
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(dateto, javax.swing.GroupLayout.Alignment.TRAILING))
                                .addGap(8, 8, 8)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(btnReset)
                                    .addComponent(btnFilter)))
                            .addComponent(jCalendar1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
    ...
    private void btsPOSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btsPOSActionPerformed
        // TODO add your handling code here:
        int confirm = JOptionPane.showConfirmDialog(this, 
            "Switch to POS (User Mode)?\n\nThis will close the Maintenance panel and open the Point of Sale system.", 
            "Confirm POS Switch", 
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            try {
                // Get the parent frame (Maintenance window)
                javax.swing.JFrame parentFrame = (javax.swing.JFrame) javax.swing.SwingUtilities.getWindowAncestor(this);
                
                if (parentFrame != null) {
                    parentFrame.dispose(); // Close Maintenance
                }
                
                // Open usermenu (POS/User mode)
                new usermenu(true).setVisible(true);
                
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, 
                    "Error switching to POS: " + e.getMessage(), 
                    "Error", 
                    JOptionPane.ERROR_MESSAGE);
                e.printStackTrace();
            }
        }
    }//GEN-LAST:event_btsPOSActionPerformed
    ...
    private javax.swing.JButton btsPOS;
